...
void cupboard()
{
    ...
    //garis lemari 1 vertikal laci pertama
    glPushMatrix();
    ...
    //garis lemari 2 vertikal laci ke dua
    glPushMatrix();
    ...
    //garis terakhir vertikal di lemari
    glPushMatrix();
    ...
    //garis horizontal sisi kanan lemari
    glPushMatrix();
    ...
    //garis horizontal sisi kiri lemari
    glPushMatrix();
    glTranslatef(4,0,5.9);
    glScalef(0.01, 1, 0.0001);
    drawCube1(0.2,0.1,0.1,  0.1, 0.05, 0.05);
    ...
    //lemari pegangan kanan yang bulet
    glPushMatrix();
    ...
    //lemari pegangan kiri yang bulet
    glPushMatrix();
...
void room()
{
    // carpet warna blue-green
    glPushMatrix();
    glTranslatef(3,-0.2,7);
    glScalef(1.3, 0.01, 1.7);
    drawCube1(0.0,0.5,0.5,  0.20, 0.05, 0.0);
    glPopMatrix();
    ...
    glScalef(5, 2, 0.1);
    drawCube1(1.0,0.5,0.0,  0.5, 0.4, 0.35);
    glPopMatrix();
    ...
    // atas kamar
     ...
     glScalef(5, 0.1, 7);
     drawCube1(1.0,1.0,0.0 , 0.5,0.45,0.4);
     glPopMatrix();
    ...
    glScalef(5, 0.1, 7);
    glTranslatef(-1,-5,0);
    drawCube1(1.0,1.0,0.0,  0.25,0.05,0);
    glPopMatrix();
}
...
void bed()
{
    ...
    drawCube1(0.1,0.1,0.1,  0.25,0.1,0.1);
    glPopMatrix();

    //tidur badan, kasur nya
    glPushMatrix();
...
void bedsideDrawer()
{
    //laci samping tempat tidur
      ...
      //laci dari laci samping kiri kasur
      glPushMatrix();
...
void window()
{
   //jendela
    ...
    //kayu/border pojok samping kanan jendela
    glPushMatrix();
    ...
    //border pojok samping kiri jendela
    glPushMatrix();
...
void myKeyboardFunc( unsigned char key, int x, int y )
{
    switch ( key )
    {
        case 'w': // pindah titik mata ke atas sepanjang sumbu Y
            eyeY+=1.0;
            break;
        case 's': // pindah titik mata ke bawah sepanjang sumbu Y
            eyeY-=1.0;
            break;
        case 'a': // pindah mata titik kiri sepanjang sumbu X
            eyeX-=1.0;
            break;
        case 'd': // pindah mata titik kanan sepanjang sumbu X
            eyeX+=1.0;
            break;
        case 'o':  //memperkecil
            eyeZ+=1;
        ...
        case 'i': //memperbesar
            eyeZ-=1;
            break;
        case 'q': //kembali ke titik mata default dan titik ref
                eyeX=7.0; eyeY=2.0; eyeZ=15.0;
                refX=0.0; refY=0.0; refZ=0.0;
            break;
        case 'j': // pindah ref point ke atas sepanjang sumbu Y
            refY+=1.0;
            break;
        case 'n': //pindah ref point ke bawah sepanjang sumbu Y
            refY-=1.0;
            break;
        case 'b': // pindah ref point ke kiri sepanjang sumbu X
            refX-=1.0;
            break;
        case 'm': // pindah titik mata ke kanan sepanjang sumbu X
            refX+=1.0;
            break;
        case 'k':  //pindah ref point jauh dari layar / sepanjang sumbu Z
            refZ+=1;
            break;
        case 'l': //pindahkan titik ref ke arah layar/sepanjang sumbu Z
            refZ-=1;
            break;
        case '1': //nyalakan dan matikan lampu pertama/utama
            if(switchOne == false)
            {
        ...
        case '2': //nyalakan dan matikan lampu ke 2
            if(switchTwo == false)
            {
        ...
        case '3': //nyalakan dan matikan lampu di atas meja samping kasur
            if(switchLamp == false)
            {
        ...
        case'4': //nyalakan dan matikan lampu ambien 1
        ...
        case'7': //nyalakan dan matikan lampu ambient 2
...
int main (int argc, char **argv)
{
    ...
    glutCreateWindow("bismillah yok bisa yok");
